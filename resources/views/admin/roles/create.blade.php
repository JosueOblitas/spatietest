                ...
                <div class="relative overflow-x-auto p-3">
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="w-60 px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500"
                                type="text" id="name" name="name" placeholder="Escribe el nombre del rol">
