                                                  ...
                                                  <div class="relative w-full max-w-md max-h-full">
                                                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                          ...
                                                          <div class="p-6 text-center">
                                                              ...
                                                              <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estas seguro de eliminar este rol?</h3>
                                                              <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" class="flex justify-center">
                                                                @csrf
                                                                @method('DELETE')
