                    ...
                    <form action="{{ route('admin.roles.update', $role) }}" method="POST">
                        ...
                        <div class="mb-4 max-w-lg">
                            ...
                            <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500"
                                type="text" value="{{ $role->name }}" id="name" name="name"
                                          ...
                                          <div class="relative w-full max-w-lg max-h-full">
                                              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                  ...
                                                  <div class="p-6 text-center">
                                                      ...
                                                      <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estas seguro de eliminar el permiso: "{{$role_permission->name}}" para el rol: "{{$role->name}}"</h3>
                                                      <form action="{{ route('admin.roles.permissions.revoke', [$role->id,$role_permission->id]) }}" method="POST" class="flex justify-center">
                                                        @csrf
                                                        @method('DELETE')
