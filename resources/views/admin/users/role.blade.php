                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    ¿Estas seguro de eliminar el rol: "{{$user_rol->name}}" para el
                                                    usuario: "{{$user->name}}"</h3>
                                                <form
                                                    action="{{ route('admin.user.roles.remove', [$user->id,$user_rol->id]) }}"
                            ...
                            <div class="mt-6">
                                <div>
                                    ...
                                    <div class="my-10">
                                        ...
                                        <span id="badge-dismiss-default"
                                            class="inline-flex items-center px-2 py-1 mr-2 text-sm font-medium text-red-800 bg-red-100 rounded dark:bg-blue-900 dark:text-blue-300">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <h3
                                                            ...
                                                            "{{$user_permission->name}}" para el usuario:
                                                            "{{$user->name}}"</h3>
                                                        <form
                                                            action="{{ route('admin.user.permission.remove', [$user->id,$user_permission->id]) }}"
                                                            method="POST" class="flex justify-center">
                                                            @csrf
                                                            @method('DELETE')
