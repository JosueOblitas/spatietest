                                ...
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex justify-end">
                                        <div class="space-x-2 flex">
                                            ...
                                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-sm" type="button">
                                                Eliminar
                                              </button>
                                                  ...
                                                  <div class="relative w-full max-w-md max-h-full">
                                                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                          ...
                                                          <div class="p-6 text-center">
                                                              ...
                                                              <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estas seguro de eliminar el permiso?</h3>
                                                              <form action="{{ route('admin.permissions.destroy', $permission->id) }}" method="POST" class="flex justify-center">
                                                                @csrf
                                                                @method('DELETE')
